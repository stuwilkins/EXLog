...
class Scan():
    """
    Scan class serves as a template for all scan routines.
    """
    ...
    def id(self, **args):
        """
        Assigns/returns scan_id for given scan instance
        """
    ...
    def timestamp(self):
        """
        Returns a dictionary of epics_timestamps for scan instances
    ...
    def __setTimeStamp(self, start, end=None):
        """
        Assigns scan start and end times.Start time is required while end time depends on developer preference
        """
